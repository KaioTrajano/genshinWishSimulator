var images = [
    ...
    banneroption.addEventListener("mouseenter", () =>{
        banneroption.src = "zhongliimage.png"  
    })
    banneroption.addEventListener("mouseleave", () =>{
        banneroption.src = "zhongliimage2.png" 
    })
    ...
    item1.style.backgroundImage = "url(epicbackground.svg)"    
    ...
    item3.getAttribute('src') == "zhongli.svg" | item4.getAttribute('src') == "zhongli.svg" | 
    item5.getAttribute('src') == "zhongli.svg" | item6.getAttribute('src') == "zhongli.svg" | 
    ...
    item3.getAttribute('src') == "zhongli.svg" ? item3.style.backgroundImage = "url('background5stars.svg')" : console.log("não é")
    item4.getAttribute('src') == "zhongli.svg" ? item4.style.backgroundImage = "url('background5stars.svg')" : console.log("não é")
    item5.getAttribute('src') == "zhongli.svg" ? item5.style.backgroundImage = "url('background5stars.svg')": console.log("não é")
    item6.getAttribute('src') == "zhongli.svg" ? item6.style.backgroundImage = "url('background5stars.svg')" : console.log("não é")
    item7.getAttribute('src') == "zhongli.svg" ? item7.style.backgroundImage = "url('background5stars.svg')": console.log("não é")
    item8.getAttribute('src') == "zhongli.svg" ? item8.style.backgroundImage = "url('background5stars.svg')" : console.log("não é")
    item9.getAttribute('src') == "zhongli.svg" ? item9.style.backgroundImage = "url('background5stars.svg')" : console.log("não é")
    item10.getAttribute('src') == "zhongli.svg" ? item10.style.backgroundImage = "url('background5stars.svg')": console.log("não é")


        pity5estrelas.innerHTML=  "Pity 5 estrelas: " + pity5
    
    item1.getAttribute('src') !== "zhongli.svg" ?
    item1.style.backgroundImage = "url('itembackground.svg')" : item1.style.backgroundImage = "url('background5stars.svg')"
    ...
    item9.getAttribute('src') == "zhongli.svg" | item10.getAttribute('src') == "zhongli.svg" ? play5starsshot() : play4starsshot()
        ...
        item1.getAttribute('src') == "item3estrelas1.svg" | item1.getAttribute('src') == "item3estrelas2.svg" | item1.getAttribute('src') == "item3estrelas3.svg" 
        | item1.getAttribute('src') == "item3estrelas4.svg" | item1.getAttribute('src') == "item3estrelas5.svg" | item1.getAttribute('src') == "item3estrelas5.svg"
        | item1.getAttribute('src') == "item3estrelas6.svg" | item1.getAttribute('src') == "item3estrelas7.svg" | item1.getAttribute('src') == "item3estrelas8.svg"
        | item1.getAttribute('src') == "item3estrelas9.svg" | item1.getAttribute('src') == "item3estrelas10.svg"
        ? item1.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item2.getAttribute('src') == "item3estrelas1.svg" | item2.getAttribute('src') == "item3estrelas2.svg" | item2.getAttribute('src') == "item3estrelas3.svg" 
        | item2.getAttribute('src') == "item3estrelas4.svg" | item2.getAttribute('src') == "item3estrelas5.svg" | item2.getAttribute('src') == "item3estrelas5.svg"
        | item2.getAttribute('src') == "item3estrelas6.svg" | item2.getAttribute('src') == "item3estrelas7.svg" | item2.getAttribute('src') == "item3estrelas8.svg"
        | item2.getAttribute('src') == "item3estrelas9.svg" | item2.getAttribute('src') == "item3estrelas10.svg"
        ? item2.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item3.getAttribute('src') == "item3estrelas1.svg" | item3.getAttribute('src') == "item3estrelas2.svg" | item3.getAttribute('src') == "item3estrelas3.svg" 
        | item3.getAttribute('src') == "item3estrelas4.svg" | item3.getAttribute('src') == "item3estrelas5.svg" | item3.getAttribute('src') == "item3estrelas5.svg"
        | item3.getAttribute('src') == "item3estrelas6.svg" | item3.getAttribute('src') == "item3estrelas7.svg" | item3.getAttribute('src') == "item3estrelas8.svg"
        | item3.getAttribute('src') == "item3estrelas9.svg" | item3.getAttribute('src') == "item3estrelas10.svg"
        ? item3.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item4.getAttribute('src') == "item3estrelas1.svg" | item4.getAttribute('src') == "item3estrelas2.svg" | item4.getAttribute('src') == "item3estrelas3.svg" 
        | item4.getAttribute('src') == "item3estrelas4.svg" | item4.getAttribute('src') == "item3estrelas5.svg" | item4.getAttribute('src') == "item3estrelas5.svg"
        | item4.getAttribute('src') == "item3estrelas6.svg" | item4.getAttribute('src') == "item3estrelas7.svg" | item4.getAttribute('src') == "item3estrelas8.svg"
        | item4.getAttribute('src') == "item3estrelas9.svg" | item4.getAttribute('src') == "item3estrelas10.svg"
        ? item4.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item1.getAttribute('src') == "item3estrelas1.svg" | item5.getAttribute('src') == "item3estrelas2.svg" | item5.getAttribute('src') == "item3estrelas3.svg" 
        | item5.getAttribute('src') == "item3estrelas4.svg" | item5.getAttribute('src') == "item3estrelas5.svg" | item5.getAttribute('src') == "item3estrelas5.svg"
        | item5.getAttribute('src') == "item3estrelas6.svg" | item5.getAttribute('src') == "item3estrelas7.svg" | item5.getAttribute('src') == "item3estrelas8.svg"
        | item5.getAttribute('src') == "item3estrelas9.svg" | item5.getAttribute('src') == "item3estrelas10.svg"
        ? item5.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item6.getAttribute('src') == "item3estrelas1.svg" | item6.getAttribute('src') == "item3estrelas2.svg" | item6.getAttribute('src') == "item3estrelas3.svg" 
        | item6.getAttribute('src') == "item3estrelas4.svg" | item6.getAttribute('src') == "item3estrelas5.svg" | item6.getAttribute('src') == "item3estrelas5.svg"
        | item6.getAttribute('src') == "item3estrelas6.svg" | item6.getAttribute('src') == "item3estrelas7.svg" | item6.getAttribute('src') == "item3estrelas8.svg"
        | item6.getAttribute('src') == "item3estrelas9.svg" | item6.getAttribute('src') == "item3estrelas10.svg"
        ? item6.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item7.getAttribute('src') == "item3estrelas1.svg" | item7.getAttribute('src') == "item3estrelas2.svg" | item7.getAttribute('src') == "item3estrelas3.svg" 
        | item7.getAttribute('src') == "item3estrelas4.svg" | item7.getAttribute('src') == "item3estrelas5.svg" | item7.getAttribute('src') == "item3estrelas5.svg"
        | item7.getAttribute('src') == "item3estrelas6.svg" | item7.getAttribute('src') == "item3estrelas7.svg" | item7.getAttribute('src') == "item3estrelas8.svg"
        | item7.getAttribute('src') == "item3estrelas9.svg" | item7.getAttribute('src') == "item3estrelas10.svg"
        ? item7.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item8.getAttribute('src') == "item3estrelas1.svg" | item8.getAttribute('src') == "item3estrelas2.svg" | item8.getAttribute('src') == "item3estrelas3.svg" 
        | item8.getAttribute('src') == "item3estrelas4.svg" | item8.getAttribute('src') == "item3estrelas5.svg" | item8.getAttribute('src') == "item3estrelas5.svg"
        | item8.getAttribute('src') == "item3estrelas6.svg" | item8.getAttribute('src') == "item3estrelas7.svg" | item8.getAttribute('src') == "item3estrelas8.svg"
        | item8.getAttribute('src') == "item3estrelas9.svg" | item8.getAttribute('src') == "item3estrelas10.svg"
        ? item8.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item9.getAttribute('src') == "item3estrelas1.svg" | item9.getAttribute('src') == "item3estrelas2.svg" | item9.getAttribute('src') == "item3estrelas3.svg" 
        | item9.getAttribute('src') == "item3estrelas4.svg" | item9.getAttribute('src') == "item3estrelas5.svg" | item9.getAttribute('src') == "item3estrelas5.svg"
        | item9.getAttribute('src') == "item3estrelas6.svg" | item9.getAttribute('src') == "item3estrelas7.svg" | item9.getAttribute('src') == "item3estrelas8.svg"
        | item9.getAttribute('src') == "item3estrelas9.svg" | item9.getAttribute('src') == "item3estrelas10.svg"
        ? item9.style.backgroundImage = "url('itembackground.svg')" : "batata"
        item10.getAttribute('src') == "item3estrelas1.svg" | item10.getAttribute('src') == "item3estrelas2.svg" | item10.getAttribute('src') == "item3estrelas3.svg" 
        | item10.getAttribute('src') == "item3estrelas4.svg" | item10.getAttribute('src') == "item3estrelas5.svg" | item10.getAttribute('src') == "item3estrelas5.svg"
        | item10.getAttribute('src') == "item3estrelas6.svg" | item10.getAttribute('src') == "item3estrelas7.svg" | item10.getAttribute('src') == "item3estrelas8.svg"
        | item10.getAttribute('src') == "item3estrelas9.svg" | item10.getAttribute('src') == "item3estrelas10.svg"
        ? item10.style.backgroundImage = "url('itembackground.svg')" : "batata"
    ...
    item1.style.backgroundImage = "url('background5stars.svg')"
    item2.style.backgroundImage = "url('epicbackground.svg')"
    ...
    if(pity5 >= 76 & pity5 < 86 ){
        item1.src = "" + pity76[Math.floor(Math.random() * pity76.length)] + "";
        item1.getAttribute('src') == "zhongli.svg" ? play5starsshot(): console.log("não é")
        item1.getAttribute('src') == "zhongli.svg" ? item1.style.backgroundImage = "url('background5stars.svg')"  : console.log("não é")
      
        item1.getAttribute('src') !== "zhongli.svg" ? play3starsshot(): console.log("não é")
        item1.getAttribute('src') !== "zhongli.svg" ? item1.style.backgroundImage = "url('itembackground.svg')" : console.log("não é")
    ...
    pity4estrelas.innerHTML = "Pity 4 estrelas: " + pity
        ...
        item1.getAttribute('src') == "yanfei.svg" | item1.getAttribute('src') == "xinqiu.svg" | item1.getAttribute('src') == "beidou.svg" ? play4starsshot() : "batata"
        item1.getAttribute('src') == "yanfei.svg" | item1.getAttribute('src') == "xinqiu.svg" | item1.getAttribute('src') == "beidou.svg" ? 
        item1.style.backgroundImage = "url('epicbackground.svg')" : "batata"
        item1.getAttribute('src') == "yanfei.svg" | item1.getAttribute('src') == "xinqiu.svg" | item1.getAttribute('src') == "beidou.svg" ? 
        pity = 0 : "batata"
        pity4estrelas.innerHTML = "Pity 4 estrelas: " + pity
        ...
        item1.getAttribute('src') == "zhongli.svg"  ? play5starsshot() : "batata"
        item1.getAttribute('src') == "zhongli.svg" ? 
        item1.style.backgroundImage = "url('background5stars.svg')" : "batata"
    ...
    function item1config(){
        ...
        item1.style.backgroundImage = "url('itembackground.svg')"
